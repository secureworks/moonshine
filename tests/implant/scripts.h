#ifndef MOONSHINE_TESTS_IMPLANT_HTTP_IMPLANT_H_
#define MOONSHINE_TESTS_IMPLANT_HTTP_IMPLANT_H_

const std::string http_implant = R"(
...
#endif //MOONSHINE_TESTS_IMPLANT_HTTP_IMPLANT_H_
