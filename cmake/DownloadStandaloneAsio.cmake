...
if(NOT ASIO_PATH)
    ...
    if(asio_ADDED)
        ...
        set(ASIO_PATH ${asio_SOURCE_DIR}/asio/include) # Required for simple-web-server
        ...
        if(WIN32 OR MinGW)
            ...
            #target_compile_definitions(asio INTERFACE _WIN32_WINNT=0x0501 WIN32_LEAN_AND_MEAN)
        endif()
    endif()
endif()